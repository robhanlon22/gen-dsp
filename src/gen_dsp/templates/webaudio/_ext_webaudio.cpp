// _ext_webaudio.cpp - Gen~ wrapper implementation for Web Audio
// This file includes genlib and the exported code, NO Emscripten headers
// Provides wrapper functions that can be called from the Emscripten bridge

#include "gen_ext_common_webaudio.h"
...
// Genlib headers (must NOT be mixed with Emscripten headers)
#include "genlib.h"
...
// Defined here to match the declaration in _ext_webaudio.h
typedef void GenState;

// Buffer support for gen~ (uses genlib's DataInterface)
#include "webaudio_buffer.h"

namespace WRAPPER_NAMESPACE {

// Define buffer instances
#ifdef WRAPPER_BUFFER_NAME_0
    WebaudioBuffer WRAPPER_BUFFER_NAME_0;
#endif
#ifdef WRAPPER_BUFFER_NAME_1
    WebaudioBuffer WRAPPER_BUFFER_NAME_1;
#endif
#ifdef WRAPPER_BUFFER_NAME_2
    WebaudioBuffer WRAPPER_BUFFER_NAME_2;
#endif
#ifdef WRAPPER_BUFFER_NAME_3
    WebaudioBuffer WRAPPER_BUFFER_NAME_3;
#endif
#ifdef WRAPPER_BUFFER_NAME_4
    WebaudioBuffer WRAPPER_BUFFER_NAME_4;
#endif
