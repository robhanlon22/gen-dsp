// _ext_chuck.cpp - Gen~ wrapper implementation for ChucK
// This file includes genlib and the exported code, NO ChucK headers
// Provides wrapper functions that can be called from the ChucK side
...
// Genlib headers (must NOT be mixed with ChucK headers)
#include "genlib.h"
