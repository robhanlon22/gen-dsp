// _ext_sc.cpp - Gen~ wrapper implementation for SuperCollider
// This file includes genlib and the exported code, NO SC headers
// Provides wrapper functions that can be called from the SC side
...
// Genlib headers (must NOT be mixed with SC headers)
#include "genlib.h"
...
// Defined here to match the declaration in _ext_sc.h
...
// Define buffer instances
    ...
    ScBuffer WRAPPER_BUFFER_NAME_0;
#endif
#ifdef WRAPPER_BUFFER_NAME_1
    ScBuffer WRAPPER_BUFFER_NAME_1;
#endif
#ifdef WRAPPER_BUFFER_NAME_2
    ScBuffer WRAPPER_BUFFER_NAME_2;
#endif
#ifdef WRAPPER_BUFFER_NAME_3
    ScBuffer WRAPPER_BUFFER_NAME_3;
#endif
#ifdef WRAPPER_BUFFER_NAME_4
    ScBuffer WRAPPER_BUFFER_NAME_4;
#endif
