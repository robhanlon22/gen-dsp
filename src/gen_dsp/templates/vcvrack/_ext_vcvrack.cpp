// _ext_vcvrack.cpp - Gen~ wrapper implementation for VCV Rack
// This file includes genlib and the exported code, NO VCV Rack headers
// Provides wrapper functions that can be called from the VCV Rack side
...
// Genlib headers (must NOT be mixed with VCV Rack headers)
#include "genlib.h"
