// _ext_clap.cpp - Gen~ wrapper implementation for CLAP
// This file includes genlib and the exported code, NO CLAP headers
// Provides wrapper functions that can be called from the CLAP side
...
// Genlib headers (must NOT be mixed with CLAP headers)
#include "genlib.h"
