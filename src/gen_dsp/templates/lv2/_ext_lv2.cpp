// _ext_lv2.cpp - Gen~ wrapper implementation for LV2
// This file includes genlib and the exported code, NO LV2 headers
// Provides wrapper functions that can be called from the LV2 side
...
// Genlib headers (must NOT be mixed with LV2 headers)
#include "genlib.h"
