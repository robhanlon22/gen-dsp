// _ext_vst3.cpp - Gen~ wrapper implementation for VST3
// This file includes genlib and the exported code, NO VST3 headers
// Provides wrapper functions that can be called from the VST3 side
...
// Genlib headers (must NOT be mixed with VST3 headers)
#include "genlib.h"
...
#ifdef WRAPPER_BUFFER_NAME_0
    GSTR(WRAPPER_BUFFER_NAME_0),
#endif
#ifdef WRAPPER_BUFFER_NAME_1
    GSTR(WRAPPER_BUFFER_NAME_1),
#endif
#ifdef WRAPPER_BUFFER_NAME_2
    GSTR(WRAPPER_BUFFER_NAME_2),
#endif
#ifdef WRAPPER_BUFFER_NAME_3
    GSTR(WRAPPER_BUFFER_NAME_3),
#endif
#ifdef WRAPPER_BUFFER_NAME_4
    GSTR(WRAPPER_BUFFER_NAME_4),
#endif
    nullptr
};
