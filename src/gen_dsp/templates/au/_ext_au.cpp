// _ext_au.cpp - Gen~ wrapper implementation for AudioUnit
// This file includes genlib and the exported code, NO AudioUnit headers
// Provides wrapper functions that can be called from the AudioUnit side
...
// Genlib headers (must NOT be mixed with AudioUnit headers)
#include "genlib.h"
...
// Defined here to match the declaration in _ext_au.h
...
// Define buffer instances
    ...
    AuBuffer WRAPPER_BUFFER_NAME_0;
#endif
#ifdef WRAPPER_BUFFER_NAME_1
    AuBuffer WRAPPER_BUFFER_NAME_1;
#endif
#ifdef WRAPPER_BUFFER_NAME_2
    AuBuffer WRAPPER_BUFFER_NAME_2;
#endif
#ifdef WRAPPER_BUFFER_NAME_3
    AuBuffer WRAPPER_BUFFER_NAME_3;
#endif
